# ============================================================
# uenoyscRNA Mouse macrophage RPCA cluster→Layer workflow v2.2.0
# ============================================================

`%||%` <- function(x, y) if (is.null(x)) y else x

UenoMphiLayer1_v2 <- c(
  "Resident Kupffer-like Mphi" = "#1B7F3A",
  "Monocyte-like Mphi" = "#35B5E5",
  "Inflammatory M1-like Mphi" = "#E64B35",
  "Pro-resolution M2-like Mphi" = "#4C72B0",
  "SPP1/TREM2 MASH-associated Mphi" = "#C44EAE",
  "Other" = "#D8D8D8"
)
...
publish_umap_v220 <- function(
  ...
  # Draw Other first so that assigned macrophage populations remain visible.
  draw_order <- order(
  ...
  ggplot2::ggplot(
    ...
    ggplot2::labs(
      ...
      caption = paste0(
        ...
        " | Palette: UenoMphiLayer1_v2.2 balanced",
