...
# ==============================================================================
# Mouse MASH macrophage analysis v4.0.1
# ==============================================================================
# Purpose:
...
#   /Users/uenoya/Projects/uenoyscRNA/analysis/Mouse_MASH_Mphi_STD_vs_CDAHFD_v4.0.1.R
#
# Important:
...
p_layer2 <- make_umap_plot(
  ...
  title = "Mouse macrophage Layer2 annotation v4.0.1.1",
  point_size = 0.52
)
