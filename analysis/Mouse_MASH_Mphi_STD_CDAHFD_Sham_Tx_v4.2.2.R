...
# ==============================================================================
# Mouse MASH macrophage analysis v4.2.2
# ==============================================================================
# Purpose:
...
#   /Users/uenoya/Projects/uenoyscRNA/analysis/Mouse_MASH_Mphi_STD_CDAHFD_Sham_Tx_v4.2.2.R
#
# Important:
...
OUTPUT_DIR <- file.path(
  ...
  "STD_CDAHFD_Sham_Tx_Layer2_v4.2.2"
)
...
canonicalize_token <- function(x) {
  ...
  # In v4.2.1, lower-case letters were removed first, so "Sham" became "S"
...
write.csv(
  cell_audit,
  file.path(OUTPUT_DIR, "Cell_level_Layer2_annotation_audit_v4.2.csv"),
  row.names = FALSE
)
...
write.csv(
  layer2_by_sample,
  file.path(OUTPUT_DIR, "Layer2_counts_proportions_by_sample_v4.2.csv"),
  row.names = FALSE
)
...
write.csv(
  layer2_by_condition,
  file.path(OUTPUT_DIR, "Layer2_counts_proportions_by_condition_v4.2.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  file.path(OUTPUT_DIR, "Strict_M1_M2_ratio_by_sample_v4.2.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  file.path(OUTPUT_DIR, "Strict_M1_M2_ratio_by_condition_v4.2.csv"),
  row.names = FALSE
)
...
write.csv(
  cluster_audit,
  file.path(OUTPUT_DIR, "Layer2_by_cluster_and_condition_audit_v4.2.csv"),
  row.names = FALSE
)
...
write.csv(
  marker_manifest,
  file.path(OUTPUT_DIR, "Layer2_marker_manifest_v4.2.csv"),
  row.names = FALSE
)
