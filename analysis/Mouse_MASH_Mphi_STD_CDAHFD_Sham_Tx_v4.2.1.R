...
# ==============================================================================
# Mouse MASH macrophage analysis v4.2.1
# ==============================================================================
# Purpose:
...
#   /Users/uenoya/Projects/uenoyscRNA/analysis/Mouse_MASH_Mphi_STD_CDAHFD_Sham_Tx_v4.2.1.R
#
# Important:
...
OUTPUT_DIR <- file.path(
  ...
  "STD_CDAHFD_Sham_Tx_Layer2_v4.2.1"
)
...
if (readr_available) {
  readr::write_csv(viewport_audit, file.path(OUTPUT_DIR, "UMAP_main_viewport_audit_v4.2.1.csv"))
} else {
  utils::write.csv(
    viewport_audit,
    file.path(OUTPUT_DIR, "UMAP_main_viewport_audit_v4.2.1.csv"),
    row.names = FALSE
  )
}
...
p_layer2 <- make_umap_plot(
  ...
  title = "Mouse macrophage Layer2 annotation v4.2.1",
  point_size = 0.52,
  x_limits = umap_viewport$x,
  y_limits = umap_viewport$y
)
save_pdf("02_UMAP_Layer2_all_conditions_v4.2.1.pdf", p_layer2, 9.2, 7.2)
...
save_pdf("03A_UMAP_Layer2_split_STD_CDAHFD_v4.2.1.pdf", p_layer2_std_cdahfd, 13.0, 6.3)
...
save_pdf("04A_UMAP_condition_STD_CDAHFD_v4.2.1.pdf", p_condition_std_cdahfd, 8.2, 6.8)
...
save_pdf("03B_UMAP_Layer2_split_Sham_Tx_v4.2.1.pdf", p_layer2_sham_tx, 13.0, 6.3)
...
save_pdf("04B_UMAP_condition_Sham_Tx_v4.2.1.pdf", p_condition_sham_tx, 8.2, 6.8)
...
save_pdf("04C_UMAP_condition_all_v4.2.1.pdf", p_condition_all, 9.2, 7.2)
...
save_pdf("05_Layer2_composition_by_sample_v4.2.1.pdf", p_composition_sample, 11.5, 6.5)
...
save_pdf("06_Strict_M1_M2_fraction_by_sample_v4.2.1.pdf", p_strict_m1_m2, 10.5, 6.5)
